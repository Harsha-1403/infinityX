...
# Initialize motors
with TMotorManager_servo_serial(port='/dev/ttyUSB_HANDLE', baud=961200, motor_params=motor_handle_params, max_mosfett_temp=50) as motor_handle:
